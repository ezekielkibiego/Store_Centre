$(document).ready(function () {
    ...
    function createModal(container) {
        ...
        var content = container.querySelector("#modalct");
        var dialog = container.querySelector("#modaldg");
        var polygon = container.querySelector("#modalpg");
        var svg = container.querySelector("#modalsg");
